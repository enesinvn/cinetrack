    ...
    <section className="animate-fade-in">
      <div className="mb-6">
        <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight bg-gradient-to-r from-white via-indigo-200 to-pink-200 bg-clip-text text-transparent">
          Tum Filmlerim & Dizilerim
        </h1>
        <p className="mt-2 text-slate-400">
          Toplam <span className="text-white font-semibold">{stats.total}</span> kayit -{' '}
      ...
      <MovieList
        ...
        onRestore={onRestore}
        emptyTitle="Koleksiyonun bos"
        emptyMessage="Ilk filmini veya dizini ekleyerek listeni olusturmaya basla."
      />
    </section>
  );
}
